# Generated by Django 2.2.2 on 2019-06-25 23:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='Ehgezly.Meals')),
                ('table', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Ehgezly.Table')),
            ],
        ),
    ]
